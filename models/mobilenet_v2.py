...
# code is based on https://github.com/pytorch/vision/blob/master/torchvision/models/mobilenetv2.py
        ...
        if expand_ratio != 1:
            ...
            layers.append(
                ConvBNReLU(
                    ...
                    activation_layer=nn.ReLU # change from ReLU6 to ReLU
                )
            )
        layers.extend([
            # dw
